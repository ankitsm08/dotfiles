...
hl.animation({ leaf = "windows", enabled = true, speed = 2.8, bezier = "easeOutQuint" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 2.1, bezier = "easeOutQuint", style = "popin 75%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 2.5, bezier = "easeOutQuint", style = "popin 75%" })
