  ...
  -- Fuzzy Finder (files, lsp, etc)
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("User", {
        ...
        callback = function()
          -- This is the Lua equivalent of "setlocal number"
          vim.wo.relativenumber = true
          vim.wo.number = true

          -- You can also add other window-local settings here if you want!
          vim.wo.wrap = true -- If you want long lines to wrap
        end,
      })
    end,
  },
